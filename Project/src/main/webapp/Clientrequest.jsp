		...
		<form action="RequestController" method="post"
			...
			<div class="form-group">
				<label for="fabric_type">Fabric Type:</label> <input type="text"
					id="fabric_type" name="fabric_type" placeholder="e.g., Cotton,silk..."required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  <label for="hexValue">Color Hex Value:</label>
        <input type="color" id="hexValue" name="hexValue" required>
			</div>
			<div class="form-group">
			...
			<button type="submit" class="btn btn-primary">Submit</button>  AND ----->
			            <a href="#" class="btn btn-primary ">Make Challan</a>
