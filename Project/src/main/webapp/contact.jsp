...
.contact-form {
	padding: 40px 0;
	margin: 0 10px;
	background-image: url('https://www.xmple.com/wallpaper/gradient-blue-white-linear-3840x2160-c2-ffffff-4682b4-a-135-f-14.svg');
		...
		<div class="form-container">
			...
			<form action="#" method="POST">
				...
				<label for="name">Name: </label> <input type="text" id="name"
					...
					name="phone"> <label for="message">Message: </label>
